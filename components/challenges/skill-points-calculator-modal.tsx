...
import { SkillPointsCalculator } from '@/components/challenges/skill-points-calculator'

export function SkillPointsCalculatorModal({
  open,
  onClose,
}: {
  open: boolean
      ...
      {open && (
        ...
        >
          <motion.div
            role="dialog"
            aria-modal="true"
            aria-labelledby="skill-calculator-title"
          ...
          >
            ...
            <div className="border-b border-border px-6 pb-4 pt-6 pr-14">
              <p className="type-kicker">Herramienta</p>
              <h2
                id="skill-calculator-title"
                className="mt-1 font-display text-xl font-semibold tracking-tight"
              >
                Calculadora de puntos
              </h2>
              <p className="mt-1 text-xs text-muted-foreground">
                2vs2 · simulá el impacto en habilidad según el ganador
              </p>
            </div>

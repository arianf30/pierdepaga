...
import { PierdePagaChallengeForm } from '@/components/challenges/pierde-paga-challenge-form'

export function PierdePagaChallengeModal({
  open,
  onClose,
}: {
  open: boolean
      ...
      {open && (
        ...
        >
          <motion.div
            role="dialog"
            aria-modal="true"
            aria-labelledby="pierde-paga-title"
